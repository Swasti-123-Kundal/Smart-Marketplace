...
const ClientContracts = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-950 dark:text-slate-50">Contracts & Agreements</h1>
        <p className="text-slate-500 text-sm">Monitor active milestones and check escrow releasing details.</p>
      </div>
      ...
      {contracts.length === 0 ? (
        <div className="flex flex-col items-center justify-center p-12 border border-dashed border-slate-200 dark:border-slate-800 rounded-2xl text-center bg-white dark:bg-slate-900/50">
          ...
          <h3 className="font-bold text-slate-800 dark:text-slate-200">No Agreements Signed Yet</h3>
          <p className="text-sm text-slate-500 max-w-sm mt-1">
            Accept proposals from freelancers to automatically generate secure escrow contracts.
          </p>
        </div>
      ) : (
